"""This script will be used to generate graphene sheet. Note that there is a specific
convention that we need to follow to specify the lattice vectors and atom positions in
LAMMPS.
...
def generate_unit_cell(a, unit="lattice", zshift=0.0):
...
def generate_sheet(a, nx, ny, unit="lattice", zshift=0.0):
    """Generate a sheet of graphene. Many of the arguments will be passed in to
    `generate_unit_cell` function, particularly `a`, `unit`, and `zshift`.
    ...
    cell0, pos0 = generate_unit_cell(a)
...
if __name__ == "__main__":
    latconst = 2.46  # Lattice constant of graphene in angstrom
