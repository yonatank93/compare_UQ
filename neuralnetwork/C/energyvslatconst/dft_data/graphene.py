...
XYZ_DIR = FILE_DIR / "xyz_files" / "graphene"
...
calc = Vasp(
    ...
    sigma=0.5,  # Small smearing width
    # k-points
    kpts=[16, 16, 1],
...
energy_file = FILE_DIR / "graphene_new.txt"
if energy_file.exists():
    ...
    for ii, a in enumerate(alist):
        ...
        atoms = Graphene("C", latticeconstant={"a": a, "c": 30})
        ...
        atoms.info["Energy"] = conf_eng
        atoms.write(XYZ_DIR / f"graphene_{a:.3f}.xyz", format="extxyz")
        # Finalize --- collect
        energy[ii] = eng
