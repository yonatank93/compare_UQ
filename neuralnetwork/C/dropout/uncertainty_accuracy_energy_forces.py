...
# This is done by evaluating the energy and atomic forces of configurations in the training/test set.
...
for structure in structures:
    ...
    ens_for_std = np.std(ens_for, axis=0)
    ...
    for ii in range(4):
        ...
        ax.errorbar(xdata, ydata, ens_for_std[:, ii], fmt=".", capsize=3)
